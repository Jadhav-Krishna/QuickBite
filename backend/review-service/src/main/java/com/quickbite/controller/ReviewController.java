...
public class ReviewController {
    ...
    public ResponseEntity<List<ReviewDTO>> getDeliveryAgentReviews(@PathVariable Long agentId) {
        return ResponseEntity.ok(reviewService.getDeliveryAgentReviews(agentId));
    }

    @GetMapping("/delivery/{agentId}/rating")
    public ResponseEntity<Double> getDeliveryAgentRating(@PathVariable Long agentId) {
