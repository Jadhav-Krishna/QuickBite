...
const CUISINES = [
  { name: 'North Indian', emoji: '🍛', image: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=1200&q=90', count: 150 },
  { name: 'South Indian', emoji: '🥘', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=1200&q=90', count: 120 },
  { name: 'Chinese', emoji: '🥢', image: 'https://images.unsplash.com/photo-1525755662778-989d0524087e?w=1200&q=90', count: 95 },
  { name: 'Italian', emoji: '🍝', image: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=1200&q=90', count: 80 },
  { name: 'Mexican', emoji: '🌮', image: 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=1200&q=90', count: 60 },
  { name: 'Japanese', emoji: '🍱', image: 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=1200&q=90', count: 70 },
  { name: 'Continental', emoji: '🥗', image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=1200&q=90', count: 85 },
  { name: 'Desserts', emoji: '🍮', image: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=1200&q=90', count: 110 },
];

const FEATURED_DISHES = [
  { name: 'Butter Chicken', cuisine: 'North Indian', price: 349, image: 'https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=1200&q=90' },
  { name: 'Masala Dosa', cuisine: 'South Indian', price: 149, image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=1200&q=90' },
  { name: 'Pad Thai', cuisine: 'Asian', price: 299, image: 'https://images.unsplash.com/photo-1559314809-0d155014e29e?w=1200&q=90' },
  { name: 'Margherita Pizza', cuisine: 'Italian', price: 299, image: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=1200&q=90' },
  { name: 'Sushi Platter', cuisine: 'Japanese', price: 599, image: 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=1200&q=90' },
  { name: 'Tacos al Pastor', cuisine: 'Mexican', price: 249, image: 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=1200&q=90' },
  { name: 'Tiramisu', cuisine: 'Dessert', price: 199, image: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=1200&q=90' },
  { name: 'Biryani', cuisine: 'Indian', price: 329, image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=1200&q=90' },
];

export default function CinematicLandingWhite() {
    ...
    <div className="cinematic-landing">
      ...
      <section ref={heroRef} className="hero-section flex items-center justify-center px-6 relative">
        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center relative z-10">
          <div>
            <h1 className="font-playfair text-6xl lg:text-7xl font-black leading-tight mb-6" style={{ color: '#111' }}>
              ...
              <div className="hero-word" style={{ color: '#111' }}>to Your Door.</div>
            </h1>

            <p className="hero-subtext text-xl mb-8 max-w-xl" style={{ color: '#666' }}>
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              ...
              <Link
                to="/restaurants"
                className="hero-cta border-2 border-gray-900 text-gray-900 px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-900 hover:text-white transition"
              >
                Explore Menu
              </Link>
            </div>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 text-sm font-bold animate-bounce" style={{ color: '#666' }}>
      ...
      <section ref={statsRef} className="stats-section">
        <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="stat-item">
            ...
            <div className="stat-label mt-2">Happy Customers</div>
          </div>
          <div className="stat-item">
            <div className="stat-number" data-target={restaurants.length || 300}>0</div>
            <div className="stat-label mt-2">Restaurant Partners</div>
          </div>
          <div className="stat-item">
            <div className="stat-number" data-target="28">0</div>
            <div className="stat-label mt-2">Min Avg. Delivery</div>
          </div>
          <div className="stat-item">
            <div className="stat-number" data-target="49">0</div>
            <div className="stat-label mt-2">★ Average Rating</div>
          </div>
        </div>
      </section>
              ...
              {restaurants.slice(0, 6).map((restaurant) => (
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    <img
                      src={restaurant.imageUrl || 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200&q=90'}
                      alt={restaurant.name}
